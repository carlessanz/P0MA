...
const ca: Dict = {
  ...
  'noacc.desc': "El teu compte existeix però encara no està vinculat a cap organització. L'equip de POMA ho ha de configurar.",
  'noacc.pending_title': 'Compte pendent de validació',
  'noacc.pending_desc': "Hem rebut la teva alta. Quan l'equip de POMA la validi, el teu panell s'obrirà.",
  'noacc.rejected_title': 'Alta no acceptada',
  'noacc.rejected_desc': "L'equip de POMA no ha acceptat aquesta alta. Si creus que és un error, escriu-nos.",
  'noacc.reason': 'Motiu',
  // instal·lació de la PWA (només mòbil, productors i receptors)
  'inst.title': 'Instal·la POMA al mòbil',
  'inst.body': "Tindràs POMA com una app més, sense escriure l'adreça cada vegada.",
  ...
  'login.user_title': 'Entra a POMA', 'login.user_subtitle': 'Per a productors i entitats receptores',
  ...
  'land.hero_sub': 'POMA, de la Fundació Espigoladors, connecta productors agraris amb entitats socials i receptores per canalitzar excedents alimentaris: menys malbaratament i més aliment aprofitat.',
  ...
  'land.p2d': 'L’equip de POMA prioritza les entitats per proximitat, tipus i capacitat, i els fa arribar l’oferta.',
  ...
  'land.prod_d': 'Pagesia, cooperatives i empreses agràries amb excedents: publica què tens i l’equip de POMA li busca sortida (donació, venda o transformació).',
  ...
  'reg.err_dades': 'Aquestes dades ja consten a POMA. Escriu a l’equip per vincular-hi el teu compte.',
  'reg.err_massa': 'Hi ha hagut massa sol·licituds. Torna-ho a provar d’aquí una estona.',
  'reg.ok_title': 'Sol·licitud rebuda',
  'reg.ok_desc': 'El teu compte s’ha creat i està pendent de validació per l’equip de POMA. Quan l’activin, el teu panell s’obrirà; mentrestant ja pots iniciar sessió per veure’n l’estat.',
  ...
  'mk.dialog_desc': 'Indica quants kg de {product} voleu recollir. Ho revisarà l’equip de POMA.',
  'mk.kg': 'Quants kg', 'mk.price': 'Preu (mínim {min} €/kg)', 'mk.send': 'Enviar interès',
  'mk.sent': "Interès enviat. L'equip de POMA el revisarà.",
...
const es: Dict = {
  ...
  'noacc.desc': 'Tu cuenta existe pero aún no está vinculada a ninguna organización. El equipo de POMA tiene que configurarlo.',
  'noacc.pending_title': 'Cuenta pendiente de validación',
  'noacc.pending_desc': 'Hemos recibido tu alta. Cuando el equipo de POMA la valide, tu panel se abrirá.',
  'noacc.rejected_title': 'Alta no aceptada',
  'noacc.rejected_desc': 'El equipo de POMA no ha aceptado esta alta. Si crees que es un error, escríbenos.',
  'noacc.reason': 'Motivo',
  // instalación de la PWA (solo móvil, productores y receptores)
  'inst.title': 'Instala POMA en el móvil',
  'inst.body': 'Tendrás POMA como una app más, sin escribir la dirección cada vez.',
  ...
  'login.user_title': 'Entra en POMA', 'login.user_subtitle': 'Para productores y entidades receptoras',
  ...
  'land.hero_sub': 'POMA, de la Fundació Espigoladors, conecta a productores agrarios con entidades sociales y receptoras para canalizar excedentes alimentarios: menos desperdicio y más alimento aprovechado.',
  ...
  'land.p2d': 'El equipo de POMA prioriza las entidades por cercanía, tipo y capacidad, y les hace llegar la oferta.',
  ...
  'land.prod_d': 'Payeses, cooperativas y empresas agrarias con excedentes: publica qué tienes y el equipo de POMA le busca salida (donación, venta o transformación).',
  ...
  'reg.err_dades': 'Esos datos ya constan en POMA. Escribe al equipo para vincular tu cuenta.',
  'reg.err_massa': 'Ha habido demasiadas solicitudes. Vuelve a probar dentro de un rato.',
  'reg.ok_title': 'Solicitud recibida',
  'reg.ok_desc': 'Tu cuenta se ha creado y está pendiente de validación por el equipo de POMA. Cuando la activen, tu panel se abrirá; mientras tanto ya puedes iniciar sesión para ver su estado.',
  ...
  'mk.dialog_desc': 'Indica cuántos kg de {product} queréis recoger. Lo revisará el equipo de POMA.',
  'mk.kg': 'Cuántos kg', 'mk.price': 'Precio (mínimo {min} €/kg)', 'mk.send': 'Enviar interés',
  'mk.sent': 'Interés enviado. El equipo de POMA lo revisará.',
